...
public final class Config {
    ...
    public static final String DOMAIN_LOCK = "34.121.25.15"; //only allow account creation for this domain
    public static final String MAGIC_CREATE_DOMAIN = "34.121.25.15";
